# genpark-visual-dag-agent-workflow-tool-chainer-skill
...
> **GenPark AI Agent Skill** -- Visual DAG agent workflow tool chainer & state checkpointer (Dify / Flowise style)
